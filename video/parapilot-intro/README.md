...
Remotion (React) 기반 parapilot 소개 영상 프로젝트.
...
src/
  ...
  ParapilotIntro.tsx # 5개 장면 시퀀스 오케스트레이션
  styles.ts          # 공통 색상, 폰트, 스타일
  scenes/
    SceneProblem.tsx   # 0-5초: GUI가 느리다 (ParaView mock + red X)
    SceneSolution.tsx  # 5-12초: parapilot 소개 + pip install 타이핑
...
# MP4 렌더링 (out/parapilot-intro.mp4)
npm run build
